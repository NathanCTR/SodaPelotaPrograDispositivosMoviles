                            ...
                            builder: (context) => InkWell(
                              ...
                              onTap: () async {
                                ...
                                if (selectedMedia != null &&
                                  ...
                                  safeSetState(() => _model
                                      .isDataUploading_uploadData90q = true);
                                  ...
                                  try {
                                    ...
                                    _model.isDataUploading_uploadData90q =
                                        false;
                                  }
                                  if (selectedUploadedFiles.length ==
                                      ...
                                      downloadUrls.length ==
                                          selectedMedia.length) {
                                    safeSetState(() {
                                      _model.uploadedLocalFile_uploadData90q =
                                          selectedUploadedFiles.first;
                                      _model.uploadedFileUrl_uploadData90q =
                                          downloadUrls.first;
                                    });
                                  } else {
                                    safeSetState(() {});
                                  ...
                                  valueOrDefault<String>(
                                    currentUserPhoto == ''
                                        ? valueOrDefault<String>(
                                            ...
                                            'https://png.pngtree.com/png-clipart/20230925/original/pngtree-flat-user-profile-icon-on-isolated-background-access-tag-social-vector-png-image_12863835.png',
                                          )
                                        : currentUserPhoto,
                                    'https://png.pngtree.com/png-clipart/20230925/original/pngtree-flat-user-profile-icon-on-isolated-background-access-tag-social-vector-png-image_12863835.png',
                                  ),
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                context
                                    .pushNamed(SubperfilUpdateWidget.routeName);
                              },
