...
import 'subperfil_update_model.dart';
export 'subperfil_update_model.dart';

class SubperfilUpdateWidget extends StatefulWidget {
  const SubperfilUpdateWidget({super.key});

  static String routeName = 'subperfilUpdate';
  static String routePath = '/subperfilUpdate';

  @override
  State<SubperfilUpdateWidget> createState() => _SubperfilUpdateWidgetState();
}

class _SubperfilUpdateWidgetState extends State<SubperfilUpdateWidget> {
  late SubperfilUpdateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SubperfilUpdateModel());
    ...
    _model.txtDireccionTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.direction, ''));
