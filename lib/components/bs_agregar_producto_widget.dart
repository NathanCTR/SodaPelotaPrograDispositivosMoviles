...
class BsAgregarProductoWidget extends StatefulWidget {
  ...
  final MenuRecord? productoSeleccionado;
        ...
        children: [
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text(
                  'Indica la cantidad de productos para ',
              ...
              children: [
                Text(
                  valueOrDefault<String>(
                    widget.productoSeleccionado?.combo,
                    'Sin nombre',
                  ),
                  style: FlutterFlowTheme.of(context).bodyMedium.override(
                        font: GoogleFonts.inter(
          ...
          Row(
            ...
            children: [
              FFButtonWidget(
                onPressed: () async {
                  await ProductoCarritoRecord.collection
                      .doc()
                      .set(createProductoCarritoRecordData(
                        sku: valueOrDefault<String>(
                          widget.productoSeleccionado?.sku,
                          '000000',
                        ),
                        ...
                        precio: valueOrDefault<int>(
                          widget.productoSeleccionado?.price,
                          000,
                        ),
                        cantidad: int.tryParse(_model.textController.text),
                        imagen: widget.productoSeleccionado?.image,
